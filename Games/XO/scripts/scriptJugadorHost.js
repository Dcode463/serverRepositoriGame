...
/* 	"nameLocal" : infoGamesUsers.nameUserLocal,
 	"avatarLocal" : infoGamesUsers.avatarUserLocal,
...
if(document.querySelector('.contenedorQuestionPerdedor').style.display === "none" && document.querySelector('.contenedorQuestionGanador').style.display === "none" ){
	...
	alert("Hay un erro en tu sistema esto por lo general ocurre cuando tu telefono o tu internet es demasiado lento, vota eso y comprate algo bueno")
  funcionEsperandoJugadorOnline()
}
})
}