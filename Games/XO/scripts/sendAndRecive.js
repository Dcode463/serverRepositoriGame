const contenedorChatSpanVercionSendAndRecive = document.querySelector('.infoWin2') // contenedor principal para chat span
const imgChatsSpanVercionSendAndRecive = document.getElementById('avatarPerdedorWin2') // img 
const contenedorChats = document.getElementById('chatWin2') // chat contenedor
...
let servidorVercionSendARev = "http://testgranada.sytes.net"
